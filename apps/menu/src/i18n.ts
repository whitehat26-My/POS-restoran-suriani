...
const DICT = {
  ms: {
    ...
    paid_title: "Sudah dibayar. Terima kasih!",
    paid_body: "Bil anda sudah dijelaskan. Jumpa lagi!",
    receipt_no: "No. resit",
  ...
  en: {
    ...
    paid_title: "Paid. Thank you!",
    paid_body: "Your bill has been settled. See you again!",
